// https://github.com/openjdk/jdk/blob/6c48f4ed707bf0b15f9b6098de30db8aae6fa40f/src/java.base/share/classes/java/net/URI.java
...
import static org.glavo.url.website.JavaURI.Exceptions.filterNonSocketInfo;
import static org.glavo.url.website.JavaURI.Exceptions.formatMsg;

public final class JavaURI
        implements Comparable<JavaURI>, Serializable {
     ...
     */
    public JavaURI(String str) throws URISyntaxException {
     ...
     * #JavaURI(String)} constructor and then invoking the {@link
     ...
     *
     * <blockquote>
     * {@code new} {@link #JavaURI(String, String, String, int, String, String, String)
     ...
     *                            violates RFC&nbsp;2396
     */
    public JavaURI(String scheme, String host, String path, String fragment)
            throws URISyntaxException {
     ...
     * URI instance as if by invoking the {@link #JavaURI(String)} constructor;
     ...
     *                            violates RFC&nbsp;2396
     */
    public JavaURI(String scheme, String ssp, String fragment)
            throws URISyntaxException {
     ...
     */
    JavaURI(String scheme, String path) {
    ...
    private static boolean validSchemeAndPath(String scheme, String path) {
        try {
            JavaURI u = new JavaURI(scheme + ':' + path);
     ...
     * #JavaURI(String)} constructor; any {@link URISyntaxException} thrown by the
     ...
     */
    public static JavaURI create(String str) {
        try {
            return new JavaURI(str);
     ...
     * RFC 2396: Uniform Resource Identifiers (URI): Generic Syntax
     */
    public JavaURI parseServerAuthority()
            throws URISyntaxException {
     ...
     * RFC 2396: Uniform Resource Identifiers (URI): Generic Syntax
     */
    public JavaURI resolve(JavaURI uri) {
     ...
     * evaluating the expression {@link #resolve(JavaURI)
     ...
     * @throws IllegalArgumentException If the given string violates RFC&nbsp;2396
     */
    public JavaURI resolve(String str) {
        return resolve(JavaURI.create(str));
    }
     ...
     * @throws NullPointerException If {@code uri} is {@code null}
     */
    public JavaURI relativize(JavaURI uri) {
     ...
     */
    public int compareTo(JavaURI that) {
        int c;
    ...
    // RFC2396 5.2
    private static JavaURI resolve(JavaURI base, JavaURI child) {
        ...
        JavaURI ru = new JavaURI();             // Resolved URI
        ru.scheme = base.scheme;
    ...
    //
    private static JavaURI normalize(JavaURI u) {
    ...
    //
    private static JavaURI relativize(JavaURI base, JavaURI child) {
        // check if child if opaque first so that NPE is thrown
        // if child is null.
        if (child.isOpaque() || base.isOpaque())
            return child;
    ...
    static final class Exceptions {
        private static final boolean enhancedSocketExceptionText = true;
        private static final boolean enhancedNonSocketExceptionText = true;
        private static final boolean enhancedUserExceptionText = true;
        private static final boolean enhancedJarExceptionText = true;
        ...
        public abstract static class SensitiveInfo {
            ...
            public Exceptions.SensitiveInfo prefixWith(String prefix) {
                this.prefix = prefix;
                return this;
            }

            public Exceptions.SensitiveInfo suffixWith(String suffix) {
                this.suffix = suffix;
                return this;
            }

            public Exceptions.SensitiveInfo replaceWith(String replacement) {
        ...
        static final class NonSocketInfo extends Exceptions.SensitiveInfo {
        ...
        public static Exceptions.SensitiveInfo filterNonSocketInfo(String host) {
            return new Exceptions.NonSocketInfo(host);
        }
         ...
         */
        public static String formatMsg(String format, Exceptions.SensitiveInfo... infos) {
            String[] args = new String[infos.length];

            int i = 0;

            for (Exceptions.SensitiveInfo info : infos) {
                args[i++] = info.output();
            }
